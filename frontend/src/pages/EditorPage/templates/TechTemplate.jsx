...
export default function TechTemplate({ data, formatLocation, formatDate, renderSectionContent }) {
    return (
        <div className={styles.template}>
            ...
            {data.personalInfo.summary && (
                <div className={styles.summary}>
                    <div className={styles.commentLine}>{'/* ABOUT */'}</div>
                    <p className={styles.summaryText}>{data.personalInfo.summary}</p>
                </div>
            )}
            <div className={styles.content}>
                {renderSectionContent(styles)}
            </div>
        </div>
    )
}
